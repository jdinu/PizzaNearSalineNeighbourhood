...
PizzaNearSalineNeigbourhoood is done as part of FEND course with Udacity
This application will give you list of pizza places near Saline,MI
User can search the filter for a specific place
If user click on the any of the filterd place, it will open the Info window giving info about the pizza place



##References
Acknowldge the help received from Udacity Comunity
Has watched many videos posted by student leaders especially Forrest(FEND)
